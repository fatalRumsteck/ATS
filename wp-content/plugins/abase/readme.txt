...
<ul>
	...
	<li><strong>db</strong> - db="" Change default database. Choose database 1, 2, ..., 9 as specified in Settings.  Sticky. (Specify once on page and override applies to remaining short codes.)
